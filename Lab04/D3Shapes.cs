...
namespace Lab04_eng
{
    ...
    {    
        ...
        public Cuboid(Rectangle rectangle, int height) : base(rectangle, height)
        {
            ++NumberOfCreatedObjects;
            _objectNumber = NumberOfCreatedObjects;
        ...
        public override double CalculateArea()
        {
            var A = ((Rectangle)_baseShape).X * _height;
            var B = ((Rectangle)_baseShape).Y * _height;
            var C = _baseShape.CalculateArea();
